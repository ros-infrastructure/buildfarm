...
<project>
  <actions/>
  <description>Generated job to create binary debs for dry stack "@(PACKAGE)". DO NOT EDIT BY HAND. Generated by catkin-debs/scripts/create_release_jobs(_fuerte).py for @(USERNAME) at @(TIMESTAMP)</description>
  <logRotator>
